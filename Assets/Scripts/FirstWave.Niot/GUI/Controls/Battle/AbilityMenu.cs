	...
	public class AbilityMenu : MonoBehaviour
	{
		...
		void Update()
		{
			if (inputTimer.IsTimeUp)
			{
				...
				{
					var up = InputManager.Instance.KeyReleased(InputManager.UP);
					var down = InputManager.Instance.KeyReleased(InputManager.DOWN);

					var left = InputManager.Instance.KeyReleased(InputManager.LEFT);
					var right = InputManager.Instance.KeyReleased(InputManager.RIGHT);
